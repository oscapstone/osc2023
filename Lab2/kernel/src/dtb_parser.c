...
void parse_dt(){
	...
	uart_puts("parse_dt_3\n");

    if ( ((unsigned long)struct_ptr < struct_end_addr) ){
        uart_puts("parse_dt_4\n");
    }
    else if ( ((unsigned long)struct_ptr > struct_end_addr) ){
        uart_puts("parse_dt_5\n");
    }
    else if ( ((unsigned long)struct_ptr == struct_end_addr) ){
        uart_puts("parse_dt_6\n");
    }
