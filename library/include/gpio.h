...
#define GPFEN0 ((volatile unsigned int *)(MMIO_BASE + 0x0020004C))
#define GPFEN1 ((volatile unsigned int *)(MMIO_BASE + 0x00200050))

#define GPHEN0 ((volatile unsigned int *)(MMIO_BASE + 0x00200058))
#define GPHEN1 ((volatile unsigned int *)(MMIO_BASE + 0x0020005C))
